...
class MemberViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let members: [EvenMember] = [
        EvenMember(key: 1, enName: "Chae-Hyun Park", krName: "박채현", tmi: "동생이 지난 달에 전역함 👽", imgAssetName: "img_ch", hash: ["#ESTJ", "#적극적", "#리더십", "#KIA팬"],
        ...
        EvenMember(key: 2, enName: "Si-Yeon Park", krName: "박시연", tmi: "집 앞 떡볶이 JMT 💕", imgAssetName: "img_sy", hash: ["#ISFJ", "#바지런함", "#부드러움", "#명예소방관"],
        ...
        EvenMember(key: 6, enName: "Sang-Kyeong Jang", krName: "장상경", tmi: "애플워치 시리즈10 구매 😈", imgAssetName: "img_sk", hash: ["#INFJ", "#책임감", "#검색능력", "#귀여움은정의"],
